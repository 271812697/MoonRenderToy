...
class  Geometry: public Base::Persistence
{
...
class  GeomBoundedCurve: public GeomCurve
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomBezierCurve: public GeomBoundedCurve
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomBSplineCurve: public GeomBoundedCurve
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
public:
     ...
     */
    void interpolate(const std::vector<gp_Pnt>&, const std::vector<gp_Vec>& ,Standard_Boolean = Standard_False);
    /*!
...
class  GeomConic: public GeomCurve
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomTrimmedCurve: public GeomBoundedCurve
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomArcOfConic: public GeomTrimmedCurve
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomCircle: public GeomConic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomArcOfCircle: public GeomArcOfConic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomEllipse: public GeomConic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomArcOfEllipse: public GeomArcOfConic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomHyperbola: public GeomConic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomArcOfHyperbola: public GeomArcOfConic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomParabola: public GeomConic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomArcOfParabola: public GeomArcOfConic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomLineSegment: public GeomTrimmedCurve
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomElementarySurface: public GeomSurface
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomCylinder: public GeomElementarySurface
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomCone: public GeomElementarySurface
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomSphere: public GeomElementarySurface
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomToroid: public GeomElementarySurface
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomPlane: public GeomElementarySurface
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomPlateSurface: public GeomSurface
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomSweptSurface: public GeomSurface
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomSurfaceOfRevolution: public GeomSweptSurface
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class  GeomSurfaceOfExtrusion: public GeomSweptSurface
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
// Helper functions for fillet tools
 ...
 std::unique_ptr<GeomSurface> makeFromSurface(
    const Handle(Geom_Surface) &,
    bool silent = false
);

 std::unique_ptr<GeomSurface> makeFromSurfaceAdaptor(
 ...
 std::unique_ptr<GeomCurve> makeFromTrimmedCurve(
