 ...
 */
class  FaceMaker: public BRepBuilderAPI_MakeShape, public Base::BaseClass
{
 ...
 */
class  FaceMakerPublic: public FaceMaker
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
 ...
 * are valid.
 */
class  FaceMakerSimple: public FaceMakerPublic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
