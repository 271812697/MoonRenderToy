...
class  XMLAttributeError: public XMLBaseException
{
public:
...
class  BadFormatError: public Exception
{
public:
...
class  MemoryException: public Exception, virtual public std::bad_alloc
#else
...
/** can be used in an own signal handler */
class  AbnormalProgramTermination: public Exception
{
public:
...
class  UnknownProgramOption: public Exception
{
public:
...
class  ProgramInformation: public Exception
{
public:
...
class  PropertyError: public AttributeError
{
public:
...
class  BadGraphError: public RuntimeError
{
public:
...
class  CADKernelError: public Exception
{
public:
...
class  RestoreError: public Exception
{
public:
