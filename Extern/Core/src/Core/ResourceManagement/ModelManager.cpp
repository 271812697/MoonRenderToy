...
::Rendering::Resources::Model* Core::ResourceManagement::ModelManager::LoadFromMemory(const std::vector<float>& v, const std::vector<unsigned int>& i)
{
	return ::Rendering::Resources::Loaders::ModelLoader::LoadFromMemory(v, i);
}
