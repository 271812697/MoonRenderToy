...
void BindLuaComponents(sol::state& p_luaState)
{
	...
	p_luaState.new_usertype<Core::Rendering::PostProcess::EffectSettings>("EffectSettings",
		"Enabled", &Core::Rendering::PostProcess::EffectSettings::enabled
	);

	p_luaState.new_usertype<Core::Rendering::PostProcess::BloomSettings>("BloomSettings",
		sol::base_classes, sol::bases<Core::Rendering::PostProcess::EffectSettings>(),
		"Threshold", &Core::Rendering::PostProcess::BloomSettings::threshold,
		"KernelSize", &Core::Rendering::PostProcess::BloomSettings::kernelSize,
		"Radius", &Core::Rendering::PostProcess::BloomSettings::radius,
		"Intensity", &Core::Rendering::PostProcess::BloomSettings::intensity,
		"Passes", &Core::Rendering::PostProcess::BloomSettings::passes
	);

	p_luaState.new_usertype<Core::Rendering::PostProcess::AutoExposureSettings>("AutoExposureSettings",
		sol::base_classes, sol::bases<Core::Rendering::PostProcess::EffectSettings>(),
		"CenterWeightBias", &Core::Rendering::PostProcess::AutoExposureSettings::centerWeightBias,
		"MinLuminanceEV", &Core::Rendering::PostProcess::AutoExposureSettings::minLuminanceEV,
		"MaxLuminanceEV", &Core::Rendering::PostProcess::AutoExposureSettings::maxLuminanceEV,
		"ExposureCompensationEV", &Core::Rendering::PostProcess::AutoExposureSettings::exposureCompensationEV,
		"Progressive", &Core::Rendering::PostProcess::AutoExposureSettings::progressive,
		"SpeedDown", &Core::Rendering::PostProcess::AutoExposureSettings::speedDown,
		"SpeedUp", &Core::Rendering::PostProcess::AutoExposureSettings::speedUp
	);

	p_luaState.new_enum<Core::Rendering::PostProcess::ETonemappingMode>("TonemappingMode", {
		{"NEUTRAL", Core::Rendering::PostProcess::ETonemappingMode::NEUTRAL},
		{"REINHARD", Core::Rendering::PostProcess::ETonemappingMode::REINHARD},
		{"REINHARD_JODIE", Core::Rendering::PostProcess::ETonemappingMode::REINHARD_JODIE},
		{"UNCHARTED2", Core::Rendering::PostProcess::ETonemappingMode::UNCHARTED2},
		{"UNCHARTED2_FILMIC", Core::Rendering::PostProcess::ETonemappingMode::UNCHARTED2_FILMIC},
		{"ACES", Core::Rendering::PostProcess::ETonemappingMode::ACES}
		});

	p_luaState.new_usertype<Core::Rendering::PostProcess::TonemappingSettings>("TonemappingSettings",
		sol::base_classes, sol::bases<Core::Rendering::PostProcess::EffectSettings>(),
		"Exposure", &Core::Rendering::PostProcess::TonemappingSettings::exposure,
		"Mode", &Core::Rendering::PostProcess::TonemappingSettings::mode,
		"GammaCorrection", &Core::Rendering::PostProcess::TonemappingSettings::gammaCorrection
	);

	p_luaState.new_usertype<Core::Rendering::PostProcess::FXAASettings>("FXAASettings",
		sol::base_classes, sol::bases<Core::Rendering::PostProcess::EffectSettings>()
	);
