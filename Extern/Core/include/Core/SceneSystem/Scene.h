...
namespace Core::SceneSystem
{
	...
	*/
	...
	public:
		...
		* @param p_target (The actor to reme from the scene)
		*/
		bool DestroyActor(ECS::Actor& p_target);

		/**
		* Collect garbages by reming Destroyed-marked actors
		*/
		...
		*/
		...
		/**
		* Callback method called everytime a component is remed on an actor of the scene
		* @param p_component
		*/
	...
	private:
		...
		//std::vector<Maths::FVector4> verticesUVX;
		//std::vector<Maths::FVector4> verticesUVY;
