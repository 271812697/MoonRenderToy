...
namespace Rendering::Geometry
{
	...
	public:
		...
		void BuildNode(SplitRequest const& req, bbox const* bounds, FVector3 const* centroids, int* primindices);

		SahSplit FindSahSplit(SplitRequest const& req, bbox const* bounds, FVector3 const* centroids, int* primindices) const;
