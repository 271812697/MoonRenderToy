...
namespace
{
	...
	struct ShaderParseResult
	{
		...
		const Rendering::Resources::Shader::FeatureSet features;
	};
	...
	struct ShaderAssembleResult
	{
		...
		Rendering::Resources::Shader::ProgramVariants variants;
	};
	...
	std::string FeatureSetToString(const Rendering::Resources::Shader::FeatureSet& features)
	{
		if (!features.empty())
		{
	...
	std::string EnableFeaturesInShaderCode(const std::string& shaderCode, const Rendering::Resources::Shader::FeatureSet& features)
	{
		if (features.empty())
		{
			return shaderCode;
	...
	std::unique_ptr<Rendering::HAL::ShaderProgram> CreateProgram(
		...
		const Rendering::Resources::Shader::FeatureSet& p_features,
...
void main()
{
	...
	*/
	ShaderParseResult ParseShader(const ShaderLoadResult& p_shaderLoadResult)
	{
		...
		Rendering::Resources::Shader::FeatureSet features;
	...
	*/
	ShaderAssembleResult AssembleShader(const ShaderParseResult& p_parseResult)
	{
		...
		{
			Rendering::Resources::Shader::FeatureSet featureSet;
		...
		{
			variants.emplace(
				Rendering::Resources::Shader::FeatureSet{},
