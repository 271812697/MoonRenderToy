...
OvMaths::FVector3 OvMaths::FMatrix4::MulPoint(const FMatrix4& p_matrix, const FVector3& p)
{
...
OvMaths::FMatrix4 OvMaths::FMatrix4::CreateCameraView(const FVector3& eye, const FVector3& look, const FVector3& up)
{
	OvMaths::FVector3 forward(eye - look);
	forward = FVector3::Normalize(forward);

	OvMaths::FVector3 upXForward(OvMaths::FVector3::Cross(up, forward));
	upXForward = FVector3::Normalize(upXForward);

	OvMaths::FVector3 v(OvMaths::FVector3::Cross(forward, upXForward));
