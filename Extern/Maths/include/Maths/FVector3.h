...
namespace Maths
{
	...
	struct FVector3
	{
		...
		FVector3 operator*(const Maths::FVector3& p_other) const;
		...
		FVector3& operator*=(const Maths::FVector3& p_other);
		...
		static FVector3 Min(const FVector3& p_left, const FVector3& p_right);
		static FVector3 Max(const FVector3& p_left, const FVector3& p_right);
