...
extern "C" {
    ...
    extern int MATERIALS_SGSR1_OFFSET;
    extern int MATERIALS_SGSR1_SIZE;
    ...
    extern int MATERIALS_GTAO_OFFSET;
    extern int MATERIALS_GTAO_SIZE;
    extern int MATERIALS_GTAOBENTNORMALS_OFFSET;
    extern int MATERIALS_GTAOBENTNORMALS_SIZE;
}
...
#define MATERIALS_SGSR1_DATA (MATERIALS_PACKAGE + MATERIALS_SGSR1_OFFSET)
...
#define MATERIALS_GTAO_DATA (MATERIALS_PACKAGE + MATERIALS_GTAO_OFFSET)
#define MATERIALS_GTAOBENTNORMALS_DATA (MATERIALS_PACKAGE + MATERIALS_GTAOBENTNORMALS_OFFSET)
