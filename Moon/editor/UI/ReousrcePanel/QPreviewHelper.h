...
namespace MOON
{
	...
	public:
		...
		void setPath(const std::string& filePath, const char* exts, bool includePreDir);
	...
	private:
		...
		// is support this ext
		bool isSupportExt(const std::string& file);

		// addToolTip
		void addToolTips(QStandardItem* item, const std::string& fullPath);
	...
	private:
		...
		std::vector<std::string> m_supportExts;
	};
}
