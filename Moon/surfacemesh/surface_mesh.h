...
#include "surfacemesh/types.h"
#include "surfacemesh/properties.h"
...
namespace  MOON {
    ...
    public:
        ...
        //! reset handle to be invalid (index=MAX_INDEX.)
        void reset() { idx_ = MAX_INDEX; }

        //! \return whether the handle is valid, i.e., the index is not equal to MAX_INDEX.
