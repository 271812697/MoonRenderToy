...
namespace utils {
	...
	inline unsigned int clz(unsigned char x) noexcept {
	...
	unsigned int inline clz(unsigned short x) noexcept {
#if __has_builtin(__builtin_clz)
	...
	unsigned int inline ctz(unsigned char x) noexcept {
	...
	unsigned int inline ctz(unsigned short x) noexcept {
#if __has_builtin(__builtin_ctz)
		return __builtin_ctz(x);
#else
		return details::ctz(x);
	...
	unsigned int inline popcount(unsigned char x) noexcept {
	...
	unsigned int inline popcount(unsigned short x) noexcept {
#if __has_builtin(__builtin_popcount)
		return __builtin_popcount(x);
#else
		return details::popcount(x);
