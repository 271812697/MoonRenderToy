...
template<>
struct utils::EnableIntegerOperators<TEST::PerViewBindingPoints> : public std::true_type {};
template<>
struct utils::EnableIntegerOperators<TEST::PerRenderableBindingPoints> : public std::true_type {};
template<>
struct utils::EnableIntegerOperators<TEST::PerMaterialBindingPoints> : public std::true_type {};

template<>
struct utils::EnableIntegerOperators<TEST::ReservedSpecializationConstants> : public std::true_type {};
template<>
struct utils::EnableIntegerOperators<TEST::PushConstantIds> : public std::true_type {};
template<>
struct utils::EnableIntegerOperators<TEST::PostProcessVariant> : public std::true_type {};

template<>
inline constexpr size_t utils::Enum::count<TEST::PostProcessVariant>() { return TEST::POST_PROCESS_VARIANT_COUNT; }
