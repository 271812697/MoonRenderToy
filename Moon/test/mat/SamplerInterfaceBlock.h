...
namespace TEST {
	...
	public:
		...
		public:
			...
			Builder& stageFlags(ShaderStageFlags stageFlags);
		...
		private:
			...
			utils::CString mName;
			ShaderStageFlags mStageFlags = ShaderStageFlags::ALL_SHADER_STAGE_FLAGS;
	...
	private:
		...
		utils::CString mName;
		ShaderStageFlags mStageFlags{}; // It's needed to check if MAX_SAMPLER_COUNT is exceeded.
