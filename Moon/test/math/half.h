...
namespace TEST {
	namespace math {
		...
		template<> struct is_arithmetic<TEST::math::half> : public std::true_type {};
...
namespace std {
	...
	template<> struct is_floating_point<TEST::math::half> : public std::true_type {};
	...
	template<>
	class numeric_limits<TEST::math::half> {
	public:
		typedef TEST::math::half type;
		...
		inline static constexpr type round_error() noexcept { return TEST::math::makeHalf(0x3800); }
		inline static constexpr type min() noexcept { return TEST::math::makeHalf(0x0400); }
		inline static constexpr type max() noexcept { return TEST::math::makeHalf(0x7bff); }
		inline static constexpr type lowest() noexcept { return TEST::math::makeHalf(0xfbff); }
		inline static constexpr type epsilon() noexcept { return TEST::math::makeHalf(0x1400); }
		inline static constexpr type infinity() noexcept { return TEST::math::makeHalf(0x7c00); }
		inline static constexpr type quiet_NaN() noexcept { return TEST::math::makeHalf(0x7fff); }
		inline static constexpr type denorm_min() noexcept { return TEST::math::makeHalf(0x0001); }
		inline static constexpr type signaling_NaN() noexcept { return TEST::math::makeHalf(0x7dff); }
	};
