...
CString to_string<filament::backend::TextureUsage>(filament::backend::TextureUsage value) noexcept {
    ...
    char string[7] = {'-', '-', '-', '-', '-', '-', 0};
    if (static_cast<int>(value) & static_cast<int>(TextureUsage::UPLOADABLE)) {
        string[0]='U';
    }
    if (static_cast<int>(value) & static_cast<int>(TextureUsage::SAMPLEABLE)) {
        string[1]='S';
    }
    if (static_cast<int>(value) & static_cast<int>(TextureUsage::COLOR_ATTACHMENT)) {
        string[2]='c';
    }
    if (static_cast<int>(value) & static_cast<int>(TextureUsage::DEPTH_ATTACHMENT)) {
        string[3]='d';
    }
    if (static_cast<int>(value) & static_cast<int>(TextureUsage::STENCIL_ATTACHMENT)) {
        string[4] = 's';
    }
    if (static_cast<int>(value) & static_cast<int>(TextureUsage::SUBPASS_INPUT)) {
        string[5]='f';
    }
    return { string, 6 };
}
...
CString to_string<filament::backend::TargetBufferFlags>(filament::backend::TargetBufferFlags value) noexcept {
    using namespace filament::backend;
    char string[7] = {'-', '-', '-', '-', '-', '-', 0};
    if (static_cast<int>(value) & static_cast<int>(TargetBufferFlags::COLOR0)) {
        string[0]='0';
    }
    if (static_cast<int>(value) & static_cast<int>(TargetBufferFlags::COLOR1)) {
        string[1]='1';
    }
    if (static_cast<int>(value) & static_cast<int>(TargetBufferFlags::COLOR2)) {
        string[2]='2';
    }
    if (static_cast<int>(value) & static_cast<int>(TargetBufferFlags::COLOR3)) {
        string[3]='3';
    }
    if (static_cast<int>(value) & static_cast<int>(TargetBufferFlags::DEPTH)) {
        string[4]='D';
    }
    if (static_cast<int>(value) & static_cast<int>(TargetBufferFlags::STENCIL)) {
        string[5]='S';
    }
    return { string, 6 };
}
