...
void CommandBufferQueue::flush() noexcept {
    ...
    switch (0) case 0: default: (!!(used <= mFreeSpace)) ? (void)0 : ::utils::details::Voidify() && ::utils::details::TPanicStream<::utils::PostconditionPanic>(__FUNCSIG__, ("D:\\Project\\C++\\NURBSDEMO\\Source\\backend\\src\\CommandBufferQueue.cpp"), 108, "used <= mFreeSpace") <<
